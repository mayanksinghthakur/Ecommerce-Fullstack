    ...
    >
      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
        ...
        <DialogPanel className="relative  w-full max-w-md  mx-auto transform overflow-hidden  bg-white rounded-lg shadow-xl transition-all">
          <div className="max-w-lg space-y-4 bg-white p-12">{children}</div>
          <div className="flex justify-end gap-4 absolute right-4 top-4">
            <button onClick={() => setOpen(false)} type="button">
              <FaTimes className="text-slate-700" size={25}></FaTimes>
            </button>
          </div>
        </DialogPanel>
      </div>

...
import Skeleton from "../shared/Skeletn";
  ...
  return (
    <div className="pt-4">
      ...
      <AddressInfoModal open={openAddressModal} setOpen={setOpenAddressModal}>
        {/* passin the AddAddressForm as children in this so the children is the special prop that is passed  */}
        <AddAddressForm
          // selectedAddress is the address we entered
